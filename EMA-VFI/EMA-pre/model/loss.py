...
class Multi_Scale_loss(torch.nn.Module):
    ...
    def forward(self, af_loss, mf_loss):
        loss = 0
        loss += l2_loss(af_loss[0], af_loss[1])
        loss += l2_loss(af_loss[1], af_loss[2])
        loss += l2_loss(af_loss[2], af_loss[0])
        loss += l2_loss(mf_loss[0], mf_loss[1])
        loss += l2_loss(mf_loss[1], mf_loss[2])
        loss += l2_loss(mf_loss[2], mf_loss[0])
        return float(loss/6)
