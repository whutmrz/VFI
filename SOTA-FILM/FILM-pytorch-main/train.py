...
def parse_args():
    ...
    parser.add_argument('--train_data', type=str, default='E:/WHU/VFI-master/Dataset', help='path to train data')
...
if __name__ == "__main__":
    ...
    train_lib.train(
        ...
        dataloader_train=data_lib.create_training_dataset(args, augmentation_fns=None),
        dataloader_test = data_lib.create_testing_dataset(args, augmentation_fns=None)
