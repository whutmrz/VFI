...
class Options(nn.Module):
    def __init__(self, pyramid_levels=5, fusion_pyramid_levels=5, specialized_levels=3, flow_convs=[3, 3, 3, 3], fusion_in_channels=[32, 64, 128, 256, 512], flow_filters=[32, 64, 128, 256], sub_levels=4, filters=64, use_aux_outputs=True):
