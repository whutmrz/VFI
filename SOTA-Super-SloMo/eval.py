...
def convert_video(source, dest, factor, batch_size=1, output_format='mp4v', output_fps=30):
...
@click.argument('input', default='E:/WHU/VFI-master/Dataset/Video/150W-600.mp4')
@click.option('--checkpoint', default='E:/WHU/VFI-master/SOTA-Super-SloMo/data/Superslomo.ckpt', help='Path to model checkpoint')
@click.option('--output', default='E:/WHU/VFI-master/Dataset/Video/150W-600-test.mp4', help='Path to output file to save')
